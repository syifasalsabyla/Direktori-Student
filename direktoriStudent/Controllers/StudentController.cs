...
namespace direktoriStudent.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Student.Include(s => s.Lecturer);
        ...
        public async Task<IActionResult> Create([Bind("StudentID,FirstName,LastName,LecturerID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,FirstName,LastName,LecturerID")] Student student)
        {
